...
const config = {
  ...
  KAFKA: {
     ...
     */
    DEBUG_EXTREME_BATCHING_PREPARE_BATCH_SIZE: defaultValue(RC.KAFKA.DEBUG_EXTREME_BATCHING_PREPARE_BATCH_SIZE, 4000),
     ...
     */
    DEBUG_EXTREME_BATCHING_PREPARE_LINGER_MS: defaultValue(RC.KAFKA.DEBUG_EXTREME_BATCHING_PREPARE_LINGER_MS, 10),
     ...
     */
    DEBUG_EXTREME_BATCHING_FULFIL_BATCH_SIZE: defaultValue(RC.KAFKA.DEBUG_EXTREME_BATCHING_PREPARE_BATCH_SIZE, 2000),
     ...
     * Description: Maximum waiting time to fill up a in-message Kafka batch
     */
    DEBUG_EXTREME_BATCHING_FULFIL_LINGER_MS: defaultValue(RC.KAFKA.DEBUG_EXTREME_BATCHING_FULFIL_LINGER_MS, 10),
