...
const config = {
  ...
  KAFKA: {
    ...
    /**
     * DEBUG_EXTREME_BATCHING_PREPARE_BATCH_SIZE
     * 
     * Description: How big should the in-message Kafka batch size be for Prepares?
     */
    DEBUG_EXTREME_BATCHING_PREPARE_BATCH_SIZE: defaultValue(RC.KAFKA.DEBUG_EXTREME_BATCHING_PREPARE_BATCH_SIZE, 8000),
    
    /**
     * DEBUG_EXTREME_BATCHING_PREPARE_LINGER_MS
     * 
     * Description: Maximum waiting time to fill up a in-message Kafka batch
     */
    DEBUG_EXTREME_BATCHING_PREPARE_LINGER_MS: defaultValue(RC.KAFKA.DEBUG_EXTREME_BATCHING_PREPARE_LINGER_MS, 1000),
    
    /**
     * DEBUG_EXTREME_BATCHING_FULFIL_BATCH_SIZE
     * 
     * Description: How big should the in-message Kafka batch size be for Fulfils?     
     */
    DEBUG_EXTREME_BATCHING_FULFIL_BATCH_SIZE: defaultValue(RC.KAFKA.DEBUG_EXTREME_BATCHING_PREPARE_BATCH_SIZE, 4000),
    
    /**
     * DEBUG_EXTREME_BATCHING_FULFIL_LINGER_MS
     * 
     * Description: Maximum waiting time to fill up a in-message Kafka batch
     */
    DEBUG_EXTREME_BATCHING_FULFIL_LINGER_MS: defaultValue(RC.KAFKA.DEBUG_EXTREME_BATCHING_FULFIL_LINGER_MS, 1000),
